        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    courseId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CouresName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CouresDescription = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CouresType = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CouresLanguage = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LessonsDescription = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    courseId = table.Column<int>(type: "int", nullable: false),
